...
export interface AuthTokenData { token: string; refreshToken: string; tokenType: "Bearer"; expiresIn: number; refreshExpiresIn: number; expiresAt: string; refreshExpiresAt: string; }
export type TokenPair = AuthTokenData;
export interface LoginData extends AuthTokenData { user: LoginUser; permissions: UserPermissions; }
...
export interface CompanyRegisterRequest {
  ...
  location: string;
  website?: string;
  founders: CompanyRegisterFounder[];
}
