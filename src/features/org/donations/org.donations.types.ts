...
export interface OrgDonation { id: string; campaignId: string; campaignTitle: string; name: string; email: string | null; phone: string | null; city: string | null; amount: number; status: OrgDonationStatus; contactMethod: string | null; paymentMethod: string | null; notes: string | null; /** Publicly anonymous only — staff keep the operational contact details. */ isAnonymous: boolean; cancelReason: string | null; createdAt: string | null; contactedAt: string | null; agreedAt: string | null; completedAt: string | null; cancelledAt: string | null }
