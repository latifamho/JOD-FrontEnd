...
import type { AdminUserActivityParams, AdminUserDonationsResponse, AdminUserPostsResponse, AdminUsersParams, AdminUsersResponse, AdminUserDetailResponse, UserCreateRequest, UserUpdateRequest, UserStatusToggleRequest, CreateUserResponse, UpdateUserResponse, ToggleUserStatusResponse, ChangeUserPasswordResponse, DeleteUserResponse } from './admin.users.types'
const ENDPOINTS = { USERS:'/admin/users', USER:(id:string)=>`/admin/users/${id}`, USER_STATUS:(id:string)=>`/admin/users/${id}/status`, USER_PASSWORD:(id:string)=>`/admin/users/${id}/password`, USER_POSTS:(id:string)=>`/admin/users/${id}/posts`, USER_DONATIONS:(id:string)=>`/admin/users/${id}/donations` } as const
